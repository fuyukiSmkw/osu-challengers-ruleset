...
# ===== Configuration =====
RULESET_URL="https://github.com/fuyukiSmkw/osu-challengers-ruleset/releases/latest/download/osu.Game.Rulesets.oCrs.dll"
RULESET_NAME="osu.Game.Rulesets.oCrs.dll"
