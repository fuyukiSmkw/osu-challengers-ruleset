...
:: ===== Configuration =====
set "RULESET_URL=https://github.com/fuyukiSmkw/osu-challengers-ruleset/releases/latest/download/osu.Game.Rulesets.oCrs.dll"
set "RULESET_NAME=osu.Game.Rulesets.oCrs.dll"

echo.
echo ============================================
echo osu!Challengers Ruleset Installer
echo ============================================
echo.
